      ...
      <div className="resume-container">
        ...
        <section className="education-section">
          ...
          <p>
            ...
            vintage electronic machine using AYAB resources, enabling innovative
            experimentation and exploration in the field of knit textiles
            <br></br>
            ...
            <br></br>
            <br></br>✷ Created detailed and user-friendly documentation, serving
            as a valuable resource for artists, engineers, and innovators
            interested in leveraging the potential of knit textiles in relation
            to their environmental impact and cultural history.
          </p>
          <br></br>
          <br></br>
          <br></br>
          ...
          <br></br>
          <p>
            ✷ Built and implemented 10+ quantum circuits, showcased proficiency
            in complex algorithm design and leveraged Qiskit tools for quantum
            programming.
            <br></br>
            <br></br>✷ Gained hands-on experience by executing and analyzing 10+
            quantum programs on both simulator backends and real IBM quantum
            devices.
            <br></br>
            ...
            #29) for the optional Qiskit final project and showcase: simulating
          ...
          <p>
            ...
            use, inspection, and maintenance of CNC machines like laser cutters
            and glow-forges
            <br></br>
          ...
          <br></br>
          <p>
            ✷ Installed, configured, maintained, and troubleshot 10+ proprietary
            software in 35+ Dartmouth workspaces, ensuring seamless learning
            experiences
            <br></br>
            <br></br>✷ Conducted comprehensive testing and verification of 300+
            classroom and workspace hardware to identify issues and validate
            ...
            valuable resources at the workstation, effectively prolonging their
            lifespan
          </p>
          <br></br>
          <br></br>
        ...
        <div className="div-block-17">
          <a
            ...
            href="https://drive.google.com/file/d/1wRxCf8l-Jhu01v-QVlE3pu_GGNPdHila/view?usp=sharing"
            // target="_blank"
            className="link dark"
          >
            Download PDF
          ...
          <a
            ...
            href="https://docs.google.com/document/d/1YiUyqN8e2PP3I0Ull5adHzXLGnzxquqBk7svaSkk7aA/edit?usp=sharing"
            // target="_blank"
            className="link dark"
          >
            Download document
