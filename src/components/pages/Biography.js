    ...
    <div className="biography-container" ref={containerRef}>
      ...
      <div className="w-layout-grid bio-statement-and-portrait">
        <div class="about-text">
          ...
          looked for projects and experiences that help me bridge this space. I
          grew up in Ghana and made my way out to New Hampshire for college (a
          very interesting transition) - I will graduate from Dartmouth in 2026,
          as an Engineering and Computer Science major.
          <br></br>
          <br></br>
        ...
        <div className="portrait-container">
          ...
          <div className="biography-social-icons">
            ...
            <a
              ...
              href="//www.instagram.com/_chr.st.an_/?hl=en#"
              target="_blank"
              rel="noopener noreferrer"
